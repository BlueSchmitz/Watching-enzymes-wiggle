...
k151 = u.select_atoms("resid 151 and protein")
...
for ts in u.trajectory:
    ...
    dists = distance_array(protein.positions, k151.positions)
    ...
    for atom in close_atoms:
        ...
        if resid not in seen and resid != 151:
            seen.add(resid)
