...
tail = u.select_atoms("resid 205:212")
barrel = u.select_atoms("protein and not resid 205:212")
n_tail = len(tail.residues)
n_barrel = len(barrel.residues)

# Align trajectory to core (TIM barrel-like region)
align.AlignTraj(u, u, select="backbone and not resid 205:212", in_memory=False).run()
...
# Tail only
dist_tail = compute_rmsd_matrix(u, "resid 205:212", sampled_frames)
