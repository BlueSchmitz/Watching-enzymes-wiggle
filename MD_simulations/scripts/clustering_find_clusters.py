...
labels_protein_0_25, Zp = hierarchical_clustering(dist_protein, cutoff=0.25)
labels_tail_0_25, Zt = hierarchical_clustering(dist_tail, cutoff=0.25)
labels_protein_0_5, Zp = hierarchical_clustering(dist_protein, cutoff=0.5)
labels_tail_0_5, Zt = hierarchical_clustering(dist_tail, cutoff=0.5)
