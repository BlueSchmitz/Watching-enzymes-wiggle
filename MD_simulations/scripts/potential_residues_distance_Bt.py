...
k168 = u.select_atoms("resid 168 and protein")
...
for ts in u.trajectory:
    ...
    dists = distance_array(protein.positions, k168.positions)
    ...
    for atom in close_atoms:
        ...
        if resid not in seen and resid != 168:
            seen.add(resid)
