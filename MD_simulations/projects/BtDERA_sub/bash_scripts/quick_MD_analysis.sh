...
#SBATCH --output=relay_analysis_%j.out
...
python $scripts/analyse_proton_candidates_speedup.py ./rep1/md1.tpr md_fit_rep1.xtc direct_candidates_rep1.csv relay_candidates_rep1.csv
