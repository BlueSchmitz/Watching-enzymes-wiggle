...
apptainer exec $GROMACS_CONTAINER gmx_mpi mdrun -deffnm em -ntmpi 1 -ntomp 16
...
apptainer exec $GROMACS_CONTAINER mdrun -deffnm nvt -cpt 15 -ntmpi 1 -ntomp 16
...
do
  ...
  apptainer exec $GROMACS_CONTAINER gmx_mpi mdrun -deffnm npt_${i} -cpt 15 -ntmpi 1 -ntomp 16
