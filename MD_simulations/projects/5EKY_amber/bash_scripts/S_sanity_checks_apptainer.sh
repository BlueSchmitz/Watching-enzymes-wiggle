...
srun apptainer exec $GROMACS_CONTAINER gmx_mpi mdrun -deffnm make_traj
...
srun apptainer exec $GROMACS_CONTAINER gmx_mpi mdrun -rerun traj.xtc -s topol_pro.tpr -e ener_pro.edr -g rerun_pro.log
...
srun apptainer exec $GROMACS_CONTAINER gmx_mpi mdrun -rerun traj.xtc -s scaled_1.00.tpr -e ener_scaled_1.00.edr -g rerun_scaled_1.00.log
# compare energies
...
srun apptainer exec $GROMACS_CONTAINER gmx_mpi mdrun -rerun traj.xtc -s scaled_0.5_all.tpr -e ener_scaled_0.5_all.edr -g rerun_scaled_0.5_all.log
...
srun apptainer exec $GROMACS_CONTAINER gmx_mpi mdrun -multidir rep0 rep1 -replex 200 -hrex -plumed plumed.dat -dlb no -ntomp $OMP_NUM_THREADS -v -nb cpu
# Inspect logs
