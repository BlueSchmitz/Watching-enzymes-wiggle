...
module load GROMACS/2023.2-foss-2023a-PLUMED-2.9.0.GMX2023
...
srun gmx_mpi mdrun -deffnm make_traj
...
srun gmx_mpi mdrun -rerun traj.xtc -s topol_pro.tpr -e ener_pro.edr -g rerun_pro.log
...
srun gmx_mpi mdrun -rerun traj.xtc -s scaled_1.00.tpr -e ener_scaled_1.00.edr -g rerun_scaled_1.00.log
# compare energies
...
srun gmx_mpi mdrun -rerun traj.xtc -s scaled_0.5_all.tpr -e ener_scaled_0.5_all.edr -g rerun_scaled_0.5_all.log
...
srun gmx_mpi mdrun -multidir rep0 rep1 -replex 200 -hrex -plumed plumed.dat -dlb no -ntomp $OMP_NUM_THREADS -v -nb cpu
# Inspect logs
