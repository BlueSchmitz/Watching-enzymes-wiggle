...
echo -e "1\n0" | apptainer exec $GROMACS_CONTAINER gmx_mpi trjconv -f md_closed.xtc -s ../rep1.00/topol.tpr -n index.ndx -o closed_2.pdb -dump 1000
echo -e "1\n0" | apptainer exec $GROMACS_CONTAINER gmx_mpi trjconv -f md_closed.xtc -s ../rep1.00/topol.tpr -n index.ndx -o closed_3.pdb -dump 10000
echo -e "1\n0" | apptainer exec $GROMACS_CONTAINER gmx_mpi trjconv -f md_closed.xtc -s ../rep1.00/topol.tpr -n index.ndx -o closed_4.pdb -dump 100000
echo -e "1\n0" | apptainer exec $GROMACS_CONTAINER gmx_mpi trjconv -f md_closed.xtc -s ../rep1.00/topol.tpr -n index.ndx -o closed_5.pdb -dump 1000000
echo -e "1\n0" | apptainer exec $GROMACS_CONTAINER gmx_mpi trjconv -f md_closed.xtc -s ../rep1.00/topol.tpr -n index.ndx -o closed_6.pdb -dump 10000000
echo -e "1\n0" | apptainer exec $GROMACS_CONTAINER gmx_mpi trjconv -f md_closed.xtc -s ../rep1.00/topol.tpr -n index.ndx -o closed_7.pdb -dump 100000000
echo -e "1\n0" | apptainer exec $GROMACS_CONTAINER gmx_mpi trjconv -f md_closed.xtc -s ../rep1.00/topol.tpr -n index.ndx -o closed_8.pdb -dump 1000000000
echo -e "1\n0" | apptainer exec $GROMACS_CONTAINER gmx_mpi trjconv -f md_closed.xtc -s ../rep1.00/topol.tpr -n index.ndx -o closed_9.pdb -dump 10000000000
echo -e "1\n0" | apptainer exec $GROMACS_CONTAINER gmx_mpi trjconv -f md_closed.xtc -s ../rep1.00/topol.tpr -n index.ndx -o closed_10.pdb -dump 100000000000