...
cp ./outputs/4_equilibration/npt_5.cpt ./outputs/$output_dir/npt_pro.cpt
...
apptainer exec $GROMACS_CONTAINER mpirun -np $SLURM_NTASKS gmx_mpi mdrun -deffnm md -cpt 15 -maxh 46.5
