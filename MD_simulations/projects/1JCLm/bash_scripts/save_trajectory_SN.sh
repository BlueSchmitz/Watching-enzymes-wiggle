...
#SBATCH -J 1JCLm_downsample_trajectory
#SBATCH -t 01:00:00
#SBATCH -p rome
#SBATCH -N 1
#SBATCH -n 8
...
#SBATCH --gpus=0
#SBATCH --output=./1JCLm_save_traj_%j.out
...
echo -e "0\n0" | apptainer exec $GROMACS_CONTAINER gmx_mpi trjconv -f traj_comp.xtc -s topol.tpr -n index.ndx -o md_200.xtc -dt 200
