...
#SBATCH --output=/scratch/blueschmitz/Watching-enzymes-wiggle/MD_simulations/projects/1JCLm/1JCLm_setup%j.out
...
mdp=../../../../mdp_templates
scripts=../../../../scripts
pdb=../../inputs/1JCLm_fill.BL00010001.pdb # Input PDB file (with correct protonation states)
