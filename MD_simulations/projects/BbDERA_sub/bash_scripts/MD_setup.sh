...
#SBATCH --gpus=0
#SBATCH --requeue
#SBATCH --output=./BbDERA_sub_setup_%j.out
...
cp ./0_parametrization_bond/BbDERA_pH7_KPS_QM.gro ./3_minimization/solv_ions.gro
cp ./0_parametrization_bond/BbDERA_pH7_KPS_QM.top ./3_minimization/topol.top
cd ./3_minimization
