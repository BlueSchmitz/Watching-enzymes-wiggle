...
#SBATCH -J EcDERA_sub3_simple_MD
#SBATCH -t 72:00:00
#SBATCH -p rome
#SBATCH -N 1
#SBATCH --ntasks=16
...
apptainer exec $GROMACS_CONTAINER gmx_mpi grompp -f $mdp/classical_MD.mdp -c closed_start.gro -p topol_pro.top -o md3.tpr -maxwarn 1
