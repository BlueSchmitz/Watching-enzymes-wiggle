...
#SBATCH --gpus=0
#SBATCH --requeue
#SBATCH --output=./1JCLd_HREX_1loop_%j.out
...
Run this script from the projects/1JCLd directory, it contains relative paths.
