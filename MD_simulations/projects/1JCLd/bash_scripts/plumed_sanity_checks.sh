...
#SBATCH -J 1JCLd_plumed_sanity_checks
#SBATCH -t 01:00:00
#SBATCH -p rome
#SBATCH -N 1
#SBATCH -n 16 
...
#SBATCH --gpus=0
#SBATCH --requeue
#SBATCH --output=./1JCLd_plumed_%j.out
...
python $scripts/energy_comparison.py energies_scaled_1.00_.xvg energies_scaled_0.5_all.xvg > energy_diff_0.5_all.log
