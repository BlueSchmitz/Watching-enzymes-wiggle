...
echo 11 0 | gmx_mpi energy -f em.edr -o potential.xvg # choose potential energy (11), 0 terminates input
...
do
  ...
  echo 17 0 | gmx_mpi energy -f npt_${i}.edr -o pressure_${i}.xvg # choose Pressure (17), 0 terminates input
  echo 23 0 | gmx_mpi energy -f npt_${i}.edr -o density_${i}.xvg # choose Density (23), 0 terminates input
  prev=npt_${i}.gro
done
...
do 
  ...
  cd ./rep${i}
  gmx_mpi grompp -f ../$hrex -c ../npt_5.gro -p scaled_${i}.top -o topol_pro.tpr
  echo "Generated topol_pro.tpr from scaled_${i}.top in ./rep${i}."
  cd ..
done 
...
gmx_mpi grompp -f $sanity_check -c npt_5.gro -p processed.top -o make_traj.tpr
gmx_mpi mdrun -deffnm make_traj
cp make_traj.xtc traj.xtc
# produce tpr for original topology
gmx_mpi grompp -f $sanity_check -c npt_5.gro -p processed.top -o topol_pro.tpr
...
gmx_mpi grompp -f $sanity_check -c npt_5.gro -p scaled_1.00.top -o scaled_1.00.tpr
...
python plot_energy_comparison.py energies_pro.xvg energies_scaled_1.00.xvg > energy_diff_1.00.log
...
srun gmx_mpi mdrun -multidir rep0 rep1 -replex 200 -plumed plumed.dat
# Inspect logs
